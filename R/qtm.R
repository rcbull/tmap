...
#' @param projection Either a \code{\link[sf:st_crs]{crs}} object or a character value. If it is a character, it can either be a \code{PROJ.4} character string. By default, the projection is used that is defined in the \code{shp} object itself.
